            ...
            <div class="form">
                ...
                <form action="" method="post">
                    <div class="form-row">
                        ...
                        <input type="text" autocomplete="off" name="username" placeholder="Enter your full name" value="<?php echo $row['username'];?>" class="form-control" required><br>
                    </div>

                    <div class="form-row">
                        <label for="email">Email</label>
                        <input type="email"  autocomplete="off" name="email" placeholder="Enter your email" required class="form-control" value="<?php echo $row['user_email'];?>">
                    </div>
                    <div class="form-row">
